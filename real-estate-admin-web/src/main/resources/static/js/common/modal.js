const commonModal = function(options) {
...
const oneBtnModal = function(message, callback) {
    commonModal({
...
const twoBtnModal = function(message, callback) {
    commonModal({
        contents: message ? message : "Error",
        submit: callback
    });
...
const commonErrorModal = function(message, callback, onlySubmit) {
    commonModal({
        contents: message ? message : "Error",
        submit: callback,
        cancel: callback,
